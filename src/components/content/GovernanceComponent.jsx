...
function GovernanceComponent() {
  ...
  return (
    <Box p={4}>
      <Box pb={8}>
        <MarkdownRenderer filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/governance/context.md`} />
        <br/>
        <QuestionsList filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/governance/questions.yaml`} />
        <br/>
        <ReferencesTable filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/governance/references.yaml`} />
      </Box>
    <hr/>
    <Box pt={4}>
              ...
              <Tr key={row.id}>
                ...
                <Td>
                  <Input
                    ...
                    placeholder="Enter Governance detials"
                  />
                </Td>
