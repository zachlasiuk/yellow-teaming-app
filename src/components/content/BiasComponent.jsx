  ...
  return (
    <Box p={4}>
      <Box pb={8}>
        ...
        <br/>
        <ReferencesTable filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/bias/references.yaml`} />
      </Box>
    <hr/>
    <Box pt={4}>
              ...
              <Tr key={row.id}>
                ...
                <Td>
                  <Input
                    ...
                    placeholder="Enter Bias design checks"
                  />
                </Td>
