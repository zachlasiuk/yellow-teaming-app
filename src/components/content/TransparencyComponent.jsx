...
function TransparencyComponent() {
  ...
  return (
    <Box p={4}>
      <Box pb={8}>
        <MarkdownRenderer filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/transparency/context.md`} />
        <br/>
        <QuestionsList filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/transparency/questions.yaml`} />
        <br/>
        <ReferencesTable filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/transparency/references.yaml`} />
      </Box>
    <hr/>
    <Box pt={4}>
      ...
      <Box p={4} borderRadius="md">
        <Table variant="simple">
          <Thead>
            <Tr>
              <Th>#</Th>
              <Th>Transparent Design Pattern</Th>
              <Th></Th>
            </Tr>
          </Thead>
          <Tbody>
              ...
              <Tr key={row.id}>
                ...
                <Td>
                  <Input
                    ...
                    placeholder="Enter Transparent Design Pattern"
                  />
                </Td>
