...
function RolesComponent() {
  ...
  return (
    <Box p={4}>
      <Box pb={8}>
        <MarkdownRenderer filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/roles/context.md`} />
        <br/>
        <QuestionsList filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/roles/questions.yaml`} />
        <br/>
        <ReferencesTable filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/roles/references.yaml`} />
      </Box>
    <hr/>
    <Box pt={4}>
