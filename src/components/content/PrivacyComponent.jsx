  ...
  return (
    <Box p={4}>
      <Box pb={8} className="markdown-info">
        <MarkdownRenderer filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/privacy/context.md`} />
        <br/>
        <QuestionsList filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/privacy/questions.yaml`} />
        <br/>
        <ReferencesTable filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/privacy/references.yaml`} />
      </Box>
    <hr/>
    <Box pt={4}>
              ...
              <Tr key={row.id}>
                ...
                <Td>
                  <Input
                    ...
                    placeholder="Enter Privacy design pattern"
                  />
                </Td>
