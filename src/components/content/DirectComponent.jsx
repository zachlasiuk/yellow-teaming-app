  ...
  return (
    <Box p={4}>
      <Box pb={8} className="markdown-info">
        <MarkdownRenderer filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/direct/context.md`} />
        <br/>
        <QuestionsList filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/direct/questions.yaml`} />
        <br/>
        <ReferencesTable filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/direct/references.yaml`} />
      </Box>
    <hr/>
    <Box pt={4}>
      <Heading as="h2" size="lg" pb={8} >
        Your Direct Consequences
      </Heading>
              ...
              <Tr key={row.id}>
                ...
                <Td>
                  <Input
                    ...
                    placeholder="Enter Direct Consequence"
                  />
                </Td>
