...
function MitigationComponent() {
  ...
  return (
    <Box p={4}>
      <Box pb={8}>
        <MarkdownRenderer filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/mitigation/context.md`} />
        <br/>
        <QuestionsList filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/mitigation/questions.yaml`} />
        <br/>
        <ReferencesTable filePath={`${import.meta.env.BASE_URL}markdown_info/success_criteria/mitigation/references.yaml`} />
      </Box>
    <hr/>
    <Box pt={4}>
...
export default MitigationComponent;
